...
function ISPConfig_getProductConfig()
{
    return [
        [
            'name' => 'hd_quota',
...
function ISPConfig_createServer($user, $params, $order, OrderProducts $product)
{
    ...
    $client_id =  ISPConfig_getClient($user, $webService);
    if (!$client_id) {
        return false;
    }
    $result = $webService
...
function ISPConfig_getClient($user, $webService)
{
    $reseller_id = 1;
    $result = $webService
...
function ISPConfig_suspendServer(User $user, $params, Orders $order, OrderProducts $product)
{
...
function ISPConfig_terminateServer($user, $params, $order) {
